...
class MWSClient{
     ...
     * @link https://docs.developer.amazonservices.com/en_US/reports/Reports_GetReportScheduleList.html
     ...
     * @link https://docs.developer.amazonservices.com/en_US/reports/Reports_ManageReportSchedule.html
     * @param string $ReportType
     * @param string $Schedule
     * @return array
     */
    public function ManageReportSchedule($ReportType, $Schedule='_15_MINUTES_')
    {
        return $this->request('ManageReportSchedule', compact('ReportType', 'Schedule'));
    }
     ...
     * @link https://docs.developer.amazonservices.com/en_US/reports/Reports_GetReport.html
...
//        } else if ($status !== false && $status['ReportProcessingStatus'] === '_DONE_') {
        $result = $this->request('GetReport', ['ReportId' => $ReportId]);
        if (is_string($result)) {
    ...
    protected function request($endPoint, array $query = [], $body = null, $raw = false)
    {
        ...
        try {
            ...
            if (
                ...
                strpos($msg, 'signature we calculated does not match') !== false
            ) {
                throw new MWSTokenException($message);
            } else {
